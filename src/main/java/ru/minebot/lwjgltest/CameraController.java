...
public class CameraController extends SceneObject {
    ...
    public void tickLogic() {
        ...
        Vec3 left = new Vec3((float)Math.cos(rotation.getX() - Math.PI/2.0f), 0, (float)Math.sin(rotation.getX() - Math.PI/2.0f));
        Vec3 forward = Utils.toVec3(Utils.multiply(Matrices.rotate(rotation.getX(), new Vec3(0, 1, 0)), Utils.multiply(Matrices.rotate(rotation.getY(), new Vec3(0, 0, 1)), new Vec4(1, 0, 0, 0))));
